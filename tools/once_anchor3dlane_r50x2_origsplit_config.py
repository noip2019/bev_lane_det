...
model_save_path = os.getenv(
    ...
    os.path.join(repo_root, "work_dirs", "once_3dlanes_anchor_r50x2_origsplit"),
)
...
default_backbone_ckpt = os.getenv(
    ...
    "/home/lijishuo/Anchor3DLane/ckpt/once_anchor3dlane++_r50x2(1).pth",
)

input_shape = (720, 960)
output_2d_shape = (180, 240)
...
backbone_name = "resnet50_v1c_anchor"
