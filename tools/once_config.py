...
val_gt_root = os.path.join(dataset_root, "val")
train_index_file = os.path.join(dataset_root, "list", "train.txt")
val_index_file = os.path.join(dataset_root, "list", "val.txt")
...
model_save_path = os.getenv("ONCE_3DLANES_WORKDIR", os.path.join(repo_root, "work_dirs", "once_3dlanes"))
...
val_skip_benchmark = os.getenv("ONCE_3DLANES_VAL_SKIP_BENCHMARK", "0") == "1"
